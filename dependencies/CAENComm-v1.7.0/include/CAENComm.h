...
#define CAEN_COMM_VERSION_MINOR			7																																//!< Minor version
...
typedef enum CAEN_Comm_ConnectionType {
	...
	CAENComm_USB_A4818_V2718		= 2,		//!< \deprecated Since 1.7. Use ::CAENComm_USB_A4818 instead.
	CAENComm_USB_A4818_V3718		= 3,		//!< \deprecated Since 1.7. Use ::CAENComm_USB_A4818 instead.
	CAENComm_USB_A4818_V4718		= 4,		//!< \deprecated Since 1.7. Use ::CAENComm_USB_A4818 instead.
...
* \return     0 = Success; negative numbers are error codes
******************************************************************************/
CAEN_COMM_DLLAPI CAENComm_ErrorCode CAEN_COMM_API CAENComm_VMEIRQCheck(int32_t VMEhandle, uint8_t *Mask);
...
* \return     0 = Success; negative numbers are error codes
******************************************************************************/
CAEN_COMM_DLLAPI CAENComm_ErrorCode CAEN_COMM_API CAENComm_VMEIACKCycle16(int32_t VMEhandle, IRQLevels Level, int *BoardID);
...
* \return     0 = Success; negative numbers are error codes
******************************************************************************/
CAEN_COMM_DLLAPI CAENComm_ErrorCode CAEN_COMM_API CAENComm_VMEIACKCycle32(int32_t VMEhandle, IRQLevels Level, int *BoardID);
...
* \return     0 = Success; negative numbers are error codes
******************************************************************************/
CAEN_COMM_DLLAPI CAENComm_ErrorCode CAEN_COMM_API CAENComm_VMEIRQWait(CAENComm_ConnectionType LinkType, int LinkNum, int ConetNode, uint8_t IRQMask, uint32_t Timeout, int32_t *VMEHandle);
...
* \param[out] data: a char[30], filled with the requested info. The only exception is for
*                   `info == CAENComm_VMELIB_handle` that requires a pointer to a int32_t.
* \return     0 = Success; negative numbers are error codes
******************************************************************************/
...
/**************************************************************************//**
* \brief     This function permits rebooting of the USB device. Works only for USB connection to Desktop/NIM digitizers.
*
* \param[in]  LinkNum: The USB link number.
* \param[in]  UseBackup: Set 0 to use the standard image, or any other value to use the backup image.
* \return     0 = Success; negative numbers are error codes
******************************************************************************/
CAEN_COMM_DLLAPI CAENComm_ErrorCode CAEN_COMM_API CAENComm_RebootDevice(uint32_t LinkNum, int UseBackup);
